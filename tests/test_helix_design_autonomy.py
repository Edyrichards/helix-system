...
def test_design_research_ranks_repos_from_fixture(tmp_path):
...
def test_design_tournament_scores_and_writes_contact_sheet_data(tmp_path):
    ...
    out = mod.write_tournament(tmp_path, "brief text", variants)
