...
required_agent = [
    ...
    'references/10-design-reasoning-engine.md','references/11-advanced-design-psychology.md','references/12-prompt-reprompt-engine.md','references/13-reference-scouting.md','references/14-screenshot-learning-loop.md','references/15-ui-pro-tournament.md','references/16-design-memory.md','references/17-behavior-psychology-map.md','references/18-conversion-ux-models.md','references/19-behavioral-screenshot-critique.md','references/20-reference-pattern-distillation.md','schemas/behavior-map.schema.json','schemas/reference-board.schema.json','schemas/design-lesson.schema.json','schemas/behavioral-critique.schema.json','scripts/helix_behavior_score.py','scripts/helix_visual_jury.py','scripts/helix_ui_pro_loop.py','GO_TO_MARKET.md','PERSONA_CATALOG.md','research/agency-agents-dissection-2026-07.md','research/browser-harness-assessment-2026-07.md','scripts/helix_reprompt.py','scripts/validate_personas.py','personas/conversion-psychologist.md','personas/prompt-architect.md','personas/design-jury-lead.md','personas/gtm-strategist.md','scripts/install_helix.sh','examples/reprompt-onboarding.md','examples/design-swarm-checkout.md','BEST_IN_CLASS_ROADMAP.md','catalog/tools.json','catalog/modules.json','catalog/personas.json','runbooks/runbooks.json','scripts/check_catalog.py','scripts/helix_convert.py','references/architecture.md','references/hermes-takeover-contract.md','references/hermes-runtime-integration.md','references/safety-security-model.md','docs/capability-map.md','docs/helix-product-strategy.md','tests/test_docs_integrity.py','CHANGELOG.md','README.md','agent.md'
]
