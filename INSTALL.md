...
Helix can generate host-specific adapter bundles from the canonical catalog:

```bash
python3 scripts/helix_convert.py --list
python3 scripts/helix_convert.py --tool claude-code
python3 scripts/helix_convert.py --tool codex
