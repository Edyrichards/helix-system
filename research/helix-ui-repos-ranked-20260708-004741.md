...
| [sa4hnd/vibra-code](https://github.com/sa4hnd/vibra-code) | 109 | GNU Affero General Public License v3.0 | 39.45 | Open-Source AI App Builder for Mobile — Build apps with AI like vibecodeapp, rork, lovable & bolt.new but fully open source. Describe what you want → AI builds it → Preview on your phone. Built with Claude Code, Expo, React Native, Convex, E2B. |
