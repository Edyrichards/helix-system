...
| UI/UX/design | screen, component, landing, dashboard, visual, screenshot, UX | `10-design-reasoning-engine.md`, `11-advanced-design-psychology.md`, `design-system-first.md`, `charts-and-design-system-adapters.md`, `design-masterclass.md`, `ui-pro-max-preflight.md`, `design-rubric-v2.md`, plus `design.md`, `uiux-system-prompt.md`, `repo-design-section.md`, `verification.md` | design read + screen job + implemented/critique details | rendered or screenshot inspected at mobile + desktop when possible; states/preflight checked |
...
| Prompt / Reprompt | prompt, agent prompt, handoff prompt, system instruction, vague user input, improve prompt | `12-prompt-reprompt-engine.md`, `08-intake-sufficiency-prompt-restructuring.md`, `prompt-library.md`, `operating-contract.md` | reprompted brief or copy-paste prompt block | intent preserved; gaps handled; role/context/deliverable/constraints/output/verification included |
...
| GTM | go-to-market, launch, positioning, pricing, distribution, market wedge | `GO_TO_MARKET.md`, `research/agency-agents-dissection-2026-07.md`, `product-strategy.md`, persona `gtm-strategist` | positioning + ICP + wedge + launch plan + proof assets | claims trace to repo/market evidence; one clear next launch step |
